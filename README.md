...
<!-- Page Placeholders -->
<div id="chat" class="page" style="display:none;"></div>
<div id="groups" class="page" style="display:none;"></div>
<div id="profile" class="page" style="display:none;"></div>
<div id="about" class="page" style="display:none;"></div>
...
setInterval(()=>{
  ...
  if(h) h.style.backgroundImage = `url(${heroImgs[i++%heroImgs.length]})`;
},3000);
</script><!-- Chat Page -->
<div id="chat" class="page" style="display:none;">
  <div class="card">
    ...
    <input type="text" id="msg" placeholder="Type a message..." style="width:70%;padding:8px;">
...
<div id="profile" class="page" style="display:none;">
  <div class="card">
    ...
    <textarea id="status" placeholder="Status..." style="width:100%;margin-top:8px;"></textarea>
...
<div id="contact" class="page" style="display:none;">
  <div class="card">
    <h3>Contact Us</h3>
    <input type="text" id="cname" placeholder="Name" style="width:100%;margin-bottom:4px;">
    <input type="email" id="cemail" placeholder="Email" style="width:100%;margin-bottom:4px;">
    <textarea id="cmessage" placeholder="Message" style="width:100%;margin-bottom:4px;"></textarea>
