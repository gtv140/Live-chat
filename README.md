...
.hero{position:relative;height:160px;border-radius:12px;display:flex;align-items:center;justify-content:center;color:var(--text);text-shadow:0 2px 6px rgba(0,0,0,0.7);margin-bottom:12px;}
...
.msg{padding:8px;margin:4px 0;border-radius:12px;word-wrap:break-word;font-size:14px;position:relative;}
.msg.me{background:#dcf8c6;text-align:right;}
.msg.other{background:#fff;text-align:left;}
.msg button{position:absolute;top:4px;right:4px;padding:2px 6px;font-size:12px;}
...
@media(max-width:480px){
  .hero{height:120px;font-size:14px;} 
  input,textarea,button{font-size:14px;padding:8px;} 
  .card{padding:8px;} 
  .msg{font-size:13px;}
  .bottom-nav i{font-size:24px;}
}
.social-icons a{margin:0 6px;font-size:20px;color:var(--pri);text-decoration:none;}
...
<p>Live Connect is a modern real-time chat platform designed for secure communication. Enjoy features like instant messaging, group chats, online status, profile management, dark mode, and more. Fully responsive and mobile-friendly experience guaranteed.</p>
<p>Follow us:</p>
